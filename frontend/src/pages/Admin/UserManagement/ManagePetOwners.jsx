...
const ManagePetOwners = ({
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {showDetails && <PetOwnerDetailsModal selectedPetOwner={selectedPetOwner} handleCloseDetails={handleCloseDetails} />}
      {showEditModal && (
        <EditOwnerModal
...
const EditOwnerModal = ({ editingOwner, handleInputChange, handleSaveEdit, setShowEditModal, loading }) => {
...
const PetOwnerDetailsModal = ({ selectedPetOwner, handleCloseDetails }) => {
