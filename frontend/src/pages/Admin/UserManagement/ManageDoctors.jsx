...
const ManageDoctors = ({
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {showDetails && <DoctorDetailsModal selectedDoctor={selectedDoctor} handleCloseDetails={handleCloseDetails} />}
      {showEditModal && (
        <EditDoctorModal
...
const EditDoctorModal = ({ editingDoctor, handleInputChange, handleSaveEdit, setShowEditModal, loading, weekDays }) => {
              ...
              <div className="flex flex-wrap gap-2">
                {weekDays.map(day => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${editingDoctor.available_days?.includes(day)
...
const DoctorDetailsModal = ({ selectedDoctor, handleCloseDetails }) => {
